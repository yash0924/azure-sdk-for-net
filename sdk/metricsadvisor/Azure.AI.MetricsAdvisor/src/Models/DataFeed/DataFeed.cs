...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public class DataFeed
    {
        ...
        internal DataFeedDetail GetDataFeedDetail()
        {
            ...
            {
                detail.AllUpIdentification = RollupSettings.AlreadyRolledUpIdentificationValue;
                detail.NeedRollup = RollupSettings.RollupType;
                detail.RollUpMethod = RollupSettings.DataFeedAutoRollupMethod;
        ...
        internal DataFeedDetailPatch GetPatchModel()
        {
            ...
            if (RollupSettings != null)
            {
                patch.AllUpIdentification = RollupSettings.AlreadyRolledUpIdentificationValue;
                patch.NeedRollup = RollupSettings.RollupType;
                patch.RollUpMethod = RollupSettings.DataFeedAutoRollupMethod;
